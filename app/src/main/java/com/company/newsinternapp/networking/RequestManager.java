...
public class RequestManager {
    ...
    public void getNewsHeadlines(ResponseListener listener, String category, String query){
        CallNewsApi callNewsApi = retrofit.create(CallNewsApi.class);
        Call<NewsApiResponse> call = callNewsApi.callHealines("in",category,query,context.getString(R.string.api_key));
        ...
        try {
            call.enqueue(new Callback<NewsApiResponse>() {
                ...
                public void onResponse(Call<NewsApiResponse> call, Response<NewsApiResponse> response) {
                    ...
                    listener.getData(response.body().getArticles(),response.message());
